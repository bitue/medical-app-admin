...
// Replace the appointmentsData constant with an empty array for initial state
const appointmentsDataPlaceholder = []
...
export default function AppointmentsGrid() {
  const [appointmentsData, setAppointmentsData] = useState<any[]>(appointmentsDataPlaceholder)
  const [expandedCard, setExpandedCard] = useState<number | null>(null)
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        ...
        if (data.status) {
          setAppointmentsData(data.data) // Set the fetched data to state
        } else {
